...
;;;;;;  "smartparens" "smartparens.el" (21154 39011))
...
Toggle Smartparens-Strict mode in every possible buffer.
With prefix ARG, turn Smartparens-Global-Strict mode on if and only if
ARG is positive.
...
Toggle Smartparens mode in every possible buffer.
With prefix ARG, turn Smartparens-Global mode on if and only if
ARG is positive.
...
Toggle Show-Smartparens mode in every possible buffer.
With prefix ARG, turn Show-Smartparens-Global mode on if and only if
ARG is positive.
...
;;;;;;  "smartparens-ruby.el") (21154 39011 252043))
